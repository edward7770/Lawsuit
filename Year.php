	...
	<div class="content container-fluid">				
		...
		<div class="page-header">
			<div class="content-page-header">
				<h5><?php echo set_value('year'); ?></h5>
				<div class="list-btn">
					<ul class="filter-list">
						<li>
							<a class="btn btn-primary" onclick="add()" ><i class="fa fa-plus-circle me-2" aria-hidden="true"></i><?php echo set_value('addNewYear'); ?></a>
						</li>
					</ul>
				</div>
			</div>
							...
							<table class="table table-center table-hover datatable" id='setData'>
								<thead class="thead-light">
									<tr>
										...
										<th><?php echo set_value('year_en'); ?></th>
										<th><?php echo set_value('year_ar'); ?></th>
									</tr>
								</thead>
								<tbody > </tbody>
...
<div class="modal fade" id="add_year" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<form id='year' action='javascript:addYear();'>
			<div class="modal-header">
				<h4 class="modal-title"><?php echo set_value("create_year"); ?></h4>
		...
		success: function (data) {
			...
			if(jsonObject.status)
			{
				...
				jQuery.each(data_array, function() {
					$('#id').val(this.yearId);
					$('#nameAr').val(this.year_ar);
					$('#nameEn').val(this.year_en);
