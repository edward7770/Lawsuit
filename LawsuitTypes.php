	...
	<div class="content container-fluid">				
		...
		<div class="page-header">
			<div class="content-page-header">
				<h5><?php echo set_value('lawsuits_Type'); ?></h5>
				<div class="list-btn">
					<ul class="filter-list">
						<li>
							<a class="btn btn-primary" onclick="add()" ><i class="fa fa-plus-circle me-2" aria-hidden="true"></i><?php echo set_value('create_LawsuitType'); ?></a>
						</li>
					</ul>
				</div>
			</div>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title"><?php echo set_value("create_LawsuitType"); ?></h4>
		...
		success: function (data) {
			...
			if(jsonObject.status)
			{
				...
				jQuery.each(data_array, function() {
					$('#id').val(this.lsTypeId);
					$('#nameAr').val(this.lsTypeName_ar);
					$('#nameEn').val(this.lsTypeName_en);
