                    ...
                    <div class="invoice-header">
                        ...
                        <div class="inv-header-right">
                            <div class="invoice-title">
                                <?php echo set_value('profit_loss_report'); ?>
                            </div>
                                                    ...
                                                    if ($stmt_payment_details->execute()) {
                                                        ...
                                                        if (count($result_payment_details) > 0) {
                                                            if (new DateTime($_POST['from']) <= new DateTime($result_payment_details[0]['paymentDate']) && new DateTime($result_payment_details[0]['paymentDate']) <= new DateTime($_POST['to'])) {
                                                                if ($_POST['payment_status'] === "cash_collected") {
                                ...
                                <div class="table-responsive" id='setData_expense'>
                                    <table class="table table-center table-hover datatable" id='setExpenseData'>
                                        <thead class="thead-light">
                                            <tr>
                                                <th>#</th>
                                                <th class="table_header_min_width_90"><?php echo set_value('payment'); ?></th>
                                                <th class="table_header_min_width_90"><?php echo set_value('expense'); ?></th>
                                                <th class="table_header_min_width_90"><?php echo set_value('income'); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody id='setData'>
                                            <tr>
                                                <td> <?php echo set_value('total'); ?> </td>
                            ...
                            <div class="invoice-table-footer mb-5">
                                ...
                                <div class="table-footer-right">
                                    <table class="totalamt-table">
                                        <tbody>
                                            <tr>
                                                <td><?php echo set_value('total')." ".set_value('profit_loss'); ?></td>
