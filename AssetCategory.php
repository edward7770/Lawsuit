	...
	<div class="content container-fluid">				
		...
		<div class="page-header">
			<div class="content-page-header">
				<h5><?php echo set_value('assetCategory'); ?></h5>
				<div class="list-btn">
					<ul class="filter-list">
						<li>
							<a class="btn btn-primary" onclick="add()" ><i class="fa fa-plus-circle me-2" aria-hidden="true"></i><?php echo set_value('addNewCategory'); ?></a>
						</li>
					</ul>
				</div>
			</div>
							...
							<table class="table table-center table-hover datatable" id='setData'>
								<thead class="thead-light">
									<tr>
										...
										<th><?php echo set_value('assetName_ar'); ?></th>
										<th><?php echo set_value('assetName_en'); ?></th>
		...
		<div class="modal-content">
			<div class="modal-body">
				<div class="form-header">
					<h3><?php echo set_value('deleteAssetCat'); ?></h3>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title"><?php echo set_value("addNewCategory"); ?></h4>
					...
					<div class="col-md-12">
						<div class="mb-4">
							<div class="form-group">
								<label for="nameAr" class="form-label"><?php echo set_value("assetName_ar"); ?> <span class="text-danger"> * </span></label>
								<input type="text" class="form-control form-control-sm" id="nameAr" placeholder="<?php echo set_value("assetName_ar"); ?>" required>
							</div>
						</div>
					</div>
					<div class="col-md-12">
						<div class="mb-4">
							<div class="form-group">
								<label for="nameEn" class="form-label"><?php echo set_value('assetName_en'); ?> <span class="text-danger"> * </span></label>
								<input type="text" class="form-control form-control-sm" id="nameEn" placeholder="<?php echo set_value("assetName_en"); ?>" required>
							</div>
						</div>
					</div>
				</div>
		...
		success: function (data) {
			...
			if(jsonObject.status)
			{
				...
				jQuery.each(data_array, function() {
					$('#id').val(this.id);
					$('#nameAr').val(this.assetCatName_ar);
					$('#nameEn').val(this.assetCatName_en);
