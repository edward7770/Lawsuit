			...
			<div class="invoice-wrapper download_section">
				<div class="inv-content">
					<div class="invoice-header" style="padding: 20px;">
						<div class="invoice-title" style="color: #2c3038; font-size: 24px; font-weight: 700;"><?php echo set_value('payment_receipt'); ?></div>
					</div>
					<div class="invoice-header">
						...
						<div class="inv-header-right">
							...
							<div class="inv-details" style="display: block;">
								...
								<div class="inv-date">
									<?php echo set_value('receipt_no'); ?>: <span><?php echo $result_paymentdata[0]['invoiceNumber']; ?></span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="invoice-table mt-2">
						<p class="mb-1"><?php echo set_value('contractAmount'); ?></p>
					...
					<div class="invoice-table mt-3 mb-2">
						<p class="mb-1"><?php echo set_value('receivedAmount'); ?></p>
						<div class="table-responsive">
							<table>
								<thead>
									<tr>
