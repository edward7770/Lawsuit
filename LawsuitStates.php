	...
	<div class="content container-fluid">				
		...
		<div class="page-header">
			<div class="content-page-header">
				<h5><?php echo set_value('state'); ?></h5>
				<div class="list-btn">
					<ul class="filter-list">
						<li>
							<a class="btn btn-primary" onclick="add()" ><i class="fa fa-plus-circle me-2" aria-hidden="true"></i><?php echo set_value('create_state'); ?></a>
						</li>
					</ul>
				</div>
			</div>
							...
							<table class="table table-center table-hover datatable"  id='setData'>
								<thead class="thead-light">
									<tr>
										...
										<th><?php echo set_value('color'); ?></th>
		...
		<div class="modal-content">
			<div class="modal-body">
				<div class="form-header">
					<h3><?php echo set_value('delete_state'); ?></h3>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title"><?php echo set_value("create_state"); ?></h4>
			...
			<div class="modal-body p-4">
				<div class="row">
					...
					<div class="col-md-12">
						<div class="mb-4">
							<label for="lscolor" class="form-label"><?php echo set_value('color'); ?> *</label>
							<input type="color" class="form-control form-control-sm" id="lscolor" required>
						</div>
					</div>
				</div>
...
function addCustomerType()
{
	...
	$.ajax({
		type:"POST",
		url: "LawsuitStatesDB.php",
		data: { action:action,nameAr:nameAr,nameEn:nameEn,lscolor:lscolor,id:id },
		...
		success: function (data) {
			...
			if(jsonObject.status)
			{
				...
				jQuery.each(data_array, function() {
					$('#id').val(this.lsStateId);
					$('#nameAr').val(this.lsStateName_ar);
					$('#nameEn').val(this.lsStateName_en);
					$('#lscolor').val(this.lsColor);
