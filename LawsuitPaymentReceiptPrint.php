                ...
                <div class="inv-content">
                    ...
                    <div class="invoice-header">
                        ...
                        <div class="inv-header-right">
                            ...
                            <div class="inv-details" style="display: block;">
                                ...
                                <div class="inv-date">
                                    <?php echo set_value('receipt_no'); ?>: <span><?php echo $_POST['invoiceNumber']; ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="invoice-address">
                        ...
                        <div class="company-details d-flex flex-wrap">
                            ...
                            <div class="gst-details col-6 d-flex">
                                <b><?php echo set_value('invoiceNumber'); ?></b>:<span>&nbsp;<?php echo $resultLawsuitDetails[0]['lawsuitInvoiceNumber']; ?></span>
                            </div>
                            <div class="gst-details col-6 mb-0 d-flex ">
                    ...
                    <div class="invoice-address" style="margin-top: 30px; display:block;">
                        ...
                        <p style="font-size: 18px;"><?php echo set_value('receivedBy'); ?></p>
                    </div>
                </div>
            </div>
