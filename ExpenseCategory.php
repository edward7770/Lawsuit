	...
	<div class="content container-fluid">				
		...
		<div class="page-header">
			<div class="content-page-header">
				<h5><?php echo set_value('expenseCategory'); ?></h5>
				<div class="list-btn">
							...
							<table class="table table-center table-hover datatable" id='setData'>
								<thead class="thead-light">
									<tr>
										...
										<th><?php echo set_value('categoryName_en'); ?></th>
		...
		<div class="modal-content">
			<div class="modal-body">
				<div class="form-header">
					<h3><?php echo set_value('deleteExpenseCat'); ?></h3>
					...
					<div class="col-md-12">
						<div class="mb-4">
							<div class="form-group">
								<label for="nameAr" class="form-label"><?php echo set_value("categoryName_ar"); ?> <span class="text-danger"> * </span></label>
								<input type="text" class="form-control form-control-sm" id="nameAr" placeholder="<?php echo set_value("categoryName_ar"); ?>" required>
							</div>
						</div>
					</div>
					<div class="col-md-12">
						<div class="mb-4">
							<div class="form-group">
								<label for="nameEn" class="form-label"><?php echo set_value('categoryName_en'); ?> <span class="text-danger"> * </span></label>
								<input type="text" class="form-control form-control-sm" id="nameEn" placeholder="<?php echo set_value("categoryName_en"); ?>" required>
							</div>
						</div>
					</div>
				</div>
		...
		success: function (data) {
			...
			if(jsonObject.status)
			{
				...
				jQuery.each(data_array, function() {
					$('#id').val(this.id);
					$('#nameAr').val(this.expCatName_ar);
					$('#nameEn').val(this.expCatName_en);
