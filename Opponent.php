	...
	<div class="content container-fluid">				
		...
		<div class="page-header">
			<div class="content-page-header">
				<h5><?php echo set_value('opponent'); ?></h5>
				<div class="list-btn">
					<ul class="filter-list">
						<li>
							<a class="btn btn-primary" onclick="add()" ><i class="fa fa-plus-circle me-2" aria-hidden="true"></i><?php echo set_value('createNewOponent'); ?></a>
						</li>
					</ul>
				</div>
			</div>
							...
							<table class="table table-center table-hover datatable" id='setData'>
								<thead class="thead-light">
									<tr>
										...
										<th><?php echo set_value('opponentPhone'); ?></th>
										<th><?php echo set_value('opponentNationality'); ?></th>
										<th><?php echo set_value('opponentAddress'); ?></th>
									</tr>
								</thead>
								<tbody > </tbody>
