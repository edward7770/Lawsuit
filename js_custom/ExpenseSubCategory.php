	...
	<div class="content container-fluid">				
		...
		<div class="page-header">
			<div class="content-page-header">
				<h5><?php echo set_value('expenseSubCategoryList'); ?></h5>
				<div class="list-btn">
					<ul class="filter-list">
						<li>
							<a class="btn btn-primary" onclick="add()" ><i class="fa fa-plus-circle me-2" aria-hidden="true"></i><?php echo set_value('addexpenseSubCat'); ?></a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="modal-content">
			<div class="modal-body">
				<div class="form-header">
					<h3><?php echo set_value('deleteExpenseSubCat'); ?></h3>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title"><?php echo set_value("addexpenseSubCat"); ?></h4>
...
function getData()
{
	...
	$.ajax({
		type:"POST",
		url: "ExpenseSubCategoryData.php",
		success: function (data) {
			if (!$.trim(data) == '') {
		...
		success: function (data) {
			...
			if(jsonObject.status)
			{
				...
				jQuery.each(data_array, function() {
					$('#id').val(this.id);
					$('#nameAr').val(this.subExpCatName_ar);
					$('#nameEn').val(this.subExpCatName_en);
