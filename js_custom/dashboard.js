		...
		success: function (data) {
			...
			if(jsonObject.status)
			{
				...
				jQuery.each(data_array, function() {
					// var dateStr1 = this.sessionDate+' '+this.sessionTime // Your date string
                    // console.log(this.sessionName);
					var dateStr = this.sessionDate; // Your date string
				  // Parse the date string using moment.js
					  var date = moment(dateStr, "YYYY-MM-DDTHH:mm:ssZ");

					  // Format the date to the desired format
					var formattedDate = date.format("YYYY-MM-DDTHH:mm:ssZ");
					item = {};
                    item['title']=this.sessionName;
					if(this.tableData=="session")
					{
						session++;
						// item['title']="Session "+session;
					...
					itemSDetail = {};
                    itemSDetail['name']=this.sessionName;
					/* if(this.tableData=="session")
						itemSDetail['name']="Session "+session;
					else
						itemSDetail['name']="Task "+task; */
