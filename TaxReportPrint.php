                                        ...
                                        <table class="table table-center table-hover datatable" id="example">
                                            <thead class="thead-light">
                                                <tr>
                                                    ...
                                                    <th class="table_header_min_width_180"><?php echo set_value('lsStagesName'); ?></th>
                                                    ...
                                                    <th class="table_header_min_width_90"><?php echo set_value('amount'); ?></th>
                                            ...
                                            <tbody id='setData'>
                                                ...
                                                ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="table_header_min_width_180"> <?php echo $value['lsStagesName']; ?> </td>
                                                                    ...
                                                                    <td class="table_header_min_width_90"><?php echo setAmountDecimal($value['amount']); ?></td>
                                                                    <td class="table_header_min_width_90"><?php echo setAmountDecimal($value['taxAmount']); ?></td>
                                ...
                                <div class="table-responsive" id='setData_expense'>
                                    <table class="table table-center table-hover datatable" id='setExpenseData'>
                                        <thead class="thead-light">
                                            <tr>
                                                <th>#</th>
                                                <th class="table_header_min_width_90"><?php echo set_value('received_tax'); ?></th>
                                                <th class="table_header_min_width_90"><?php echo set_value('paid_tax'); ?></th>
                                                <th class="table_header_min_width_90"><?php echo set_value('payable_tax'); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody id='setData'>
                                            <tr>
                                                <td> </td>
                                                <td> <?php echo $total_payment+$total_income; ?> </td>
                                                <td> <?php echo ($total_expense); ?> </td>
                                                <td> <?php echo $total_payment+$total_income-$total_expense; ?> </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="invoice-table-footer mb-5">
                                ...
                                <div class="table-footer-right">
                                    <table class="totalamt-table">
                                        <tbody>
                                            <tr>
                                                <td><?php echo set_value('total_tax'); ?></td>
                                                <td><?php echo $total_payment + $total_income - $total_expense; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
