<div class="card-header">
	<div class="d-flex justify-content-between align-items-center">
		<h5 class="card-title"><?php echo set_value('sessions'); ?></h5>
	</div>
</div>
<div class="card-body">
		...
		<div class="col-sm-12">
			<div class="card-table">
				<div class="card-body">
						...
						<table id="lawsuitTable" class="table table-center table-hover datatable">
							<thead class="thead-light">
								<tr>
										...
										<th><?php echo set_value('nameReasonSession'); ?></th>
							...
							<tbody>
								<?php 
									...
									{
										$custId="-1";
										$qry="CALL sp_getSessions_Search(:lang,:custId,:txtSearch)";
										...
										<tr>
											...
											<td><a href="javascript:showLSSearch(<?php echo $row['lsMasterId'].",".$row['lsDetailsId'].",".$row['lsSessionId'].",session"; ?>);" class="btn-action-icon me-2"><span><i class="fe fe-eye"></i></span></a> </td>
					...
					<input type='hidden' id='lsCountSession' value="<?php if(isset($serial)) echo $serial; else echo "0"; ?>" >
