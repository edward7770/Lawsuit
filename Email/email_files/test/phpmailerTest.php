...
class PHPMailerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->Mail->Helo = 'pphisindh.org.localdomain';
    ...
    public function checkChanges()
    {
        ...
        if ($this->Mail->Helo != 'pphisindh.org.localdomain') {
...
EOT;
    ...
    public function testPopBeforeSmtpGood()
    {
        ...
        $this->assertTrue(
            POP3::popBeforeSmtp('pphisindh.org', 1100, 10, 'user', 'test', $this->Mail->SMTPDebug),
    ...
    public function testPopBeforeSmtpBad()
    {
        ...
        $this->assertFalse(
            POP3::popBeforeSmtp('pphisindh.org', 1101, 10, 'user', 'xxx', $this->Mail->SMTPDebug),
    ...
    public function testSmtpConnect()
    {
        ...
        $this->Mail->smtpClose();
        $this->Mail->Host = "ssl://pphisindh.org:12345;tls://pphisindh.org:587;10.10.10.10:54321;pphisindh.org:12345;10.10.10.10";
        $this->assertFalse($this->Mail->smtpConnect(), 'SMTP bad multi-connect succeeded');
        $this->Mail->smtpClose();
        $this->Mail->Host = "pphisindh.org:12345;10.10.10.10:54321;" . $_REQUEST['mail_host'];
        $this->assertTrue($this->Mail->smtpConnect(), 'SMTP multi-connect failed');
        $this->Mail->smtpClose();
        $this->Mail->Host = " pphisindh.org:12345 ; " . $_REQUEST['mail_host'] . ' ';
