	...
	<div class="content container-fluid">				
		...
		<div class="page-header">
			<div class="content-page-header">
				<h5><?php echo set_value('CustomerAdjectives'); ?></h5>
				<div class="list-btn">
					<ul class="filter-list">
						<li>
							<a class="btn btn-primary" onclick="add()" ><i class="fa fa-plus-circle me-2" aria-hidden="true"></i><?php echo set_value('create_CustomerAdjective'); ?></a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="modal-content">
			<div class="modal-body">
				<div class="form-header">
					<h3><?php echo set_value('delete_CustomerAdjective'); ?></h3>
		...
		<div class="modal-content">
			<form id='customer_type' action='javascript:addCustomerType();'>
				<div class="modal-header">
					<h4 class="modal-title"><?php echo set_value("create_CustomerAdjective"); ?></h4>
				...
				success: function (data) {
					...
					if(jsonObject.status)
					{
						...
						jQuery.each(data_array, function() {
							$('#id').val(this.custAdjectiveId);
							$('#nameAr').val(this.adjectiveName_ar);
							$('#nameEn').val(this.adjectiveName_en);
