...
$fileName = "Profit&Loss_Report" . date('Y-m-d') . ".xls";
...
$excelData .= "\n";
$excelData .= "\n";
$excelData .= "\t" . set_value('payment') . "\t" . set_value('income') . "\t" . set_value('expense') . "\n";
$excelData .= set_value('total') . "\t" . $total_payment . "\t". $total_income . "\t". $total_expense ."\n";
$excelData .= "\n";
$excelData .= "\n";
